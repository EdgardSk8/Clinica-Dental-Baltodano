...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    try {
        ...
        if (!slug) {
            throw new Error('No se especificó el usuario.');
        }
        ...
        if (usuario.ciudad_id) {
            ...
            if (errorRedes) {
                ...
                console.error(
                    'Error al consultar redes sociales:',
                    errorRedes
                );

                throw new Error(
                    'Error al consultar las redes sociales.'
                );
            }
...
function generarPresentacion(usuario, ciudad) {
    ...
    if (ciudad.nombre) {
        ...
        const ciudadElemento =
            document.createElement('p');

        ciudadElemento.className =
            'presentacion_ciudad';

        ciudadElemento.textContent =
            ciudad.nombre;
...
function generarDatosUsuario(usuario, ciudad) {
            ...
            <div class="col">
                ...
                <div class="card h-100 border-0 shadow-sm rounded-4 p-3 transition-hover custom-card">
                    ...
                    <div class="card-body d-flex align-items-center gap-3 p-0">
                        ...
                        <div class="icon-box-sm rounded-3 custom-primary-subtle custom-primary d-flex align-items-center justify-content-center flex-shrink-0">
                        ...
                        <div class="overflow-hidden">
                            ...
                            <span class="d-block text-uppercase custom-text-secondary fw-bold fs-7 tracking-wider mb-1">
                            ...
                            <span class="d-block custom-text fw-bold text-truncate fs-8">
                    ...
                    >
                        ...
                        <div class="card-body d-flex align-items-center gap-2 p-0">
                            ...
                            <div class="overflow-hidden">
                                ...
                                <span class="d-block fw-bold text-truncate custom-social-title custom-social-text-color">
